...
void plotComparison(TCanvas *c, TH1 *h1, TH1 *h2,TH1 *h3, TH1 *hRatio1, TH1 *hRatio2,
    ...
    gPad->SetLogx();
    setPadStyle();
    //hRatio1->GetXaxis()->SetRangeUser(0.,500.);
...
void Compare_gen_mAOD_forest() {
    ...
    TFile *f = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_miniAOD_test_onlyHPcut.root","READ");

    TDirectoryFile *g1 = (TDirectoryFile*) f->Get("defaultCPDC");
    TDirectoryFile *g2 = (TDirectoryFile*) g1->Get("QAplots");

    TFile *f1 = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_forest_test_onlyHPcut.root","READ");

    
    TH1F *htrkptgenaod       = (TH1F*) g2->Get("hpt_gen_inc");
    TH1F *htrkptgenforest    = (TH1F*) f1->Get("hgentrkpt");
    ...
    //    return;
    make1DRatio(hptRatioforaod, htrkptgenaod, "forest/miniAOD", 2);
    //return;
    ...
    plotComparison(c1, htrkptgenforest,htrkptgenaod,htrkptgenaod,hptRatioforaod,hptRatioforaod, "Forest gen","miniAOD gen","miniAODgen",0.5,1000.,"Track pT");

    c1->SaveAs("../Plots/ComparisongenmAODforest.pdf");
