...
void Compare_reco_mAOD_forest() {
    ...
    TFile *f = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_miniAOD.root","READ");
    ...
    plotComparison(c1, htrkptgenforest,htrkptgenaod,htrkptgenaod,hptRatioforaod,hptRatioforaod, "Forest reco","miniAOD reco","miniAOD reco",0.1,500.,"Track pT");

    c1->SaveAs("../Plots/ComparisonrecomAODforest.pdf");
