...
//________________
void Compare_reco_mAOD_AOD_eta() {
    ...
    TH1F *htrkptgenaod       = (TH1F*) g2->Get("heta_inc");
    //forest is mini AOD
    TH1F *htrkptgenforest    = (TH1F*) g4->Get("heta_inc");
    ...
    htrkptgenaod->Rebin(2);
    htrkptgenforest->Rebin(2);
    ...
    plotComparison(c1, htrkptgenforest,htrkptgenaod,htrkptgenaod,hptRatioforaod,hptRatioforaod, "mini AOD reco","AOD reco","AODreco",-1,1.,"Track eta");

    c1->SaveAs("../Plots/ComparisonrecomAOD_AOD_eta.pdf");
