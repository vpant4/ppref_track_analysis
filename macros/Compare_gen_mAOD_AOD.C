...
void Compare_gen_mAOD_AOD() {
    ...
    TFile *f1 = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_miniAOD.root","READ");
    ...
    //forest is mini AOD
    TH1F *htrkptgenforest    = (TH1F*) g4->Get("hpt_gen_inc");
    ...
    //    return;
    make1DRatio(hptRatioforaod, htrkptgenaod, "mini AOD / AOD", 2);
    //return;
    ...
    plotComparison(c1, htrkptgenforest,htrkptgenaod,htrkptgenaod,hptRatioforaod,hptRatioforaod, "mini AOD gen","AOD gen","AODgen",0.5,1000.,"Track pT");

    c1->SaveAs("../Plots/ComparisongenmAOD_AOD.pdf");
