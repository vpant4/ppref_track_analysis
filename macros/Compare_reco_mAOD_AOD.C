...
void Compare_reco_mAOD_AOD() {
    ...
    //forest is mini AOD
    TH1F *htrkptgenforest    = (TH1F*) g4->Get("hpt_inc");
    ...
    plotComparison(c1, htrkptgenforest,htrkptgenaod,htrkptgenaod,hptRatioforaod,hptRatioforaod, "mini AOD reco","AOD reco","AODreco",0.5,1000.,"Track pT");

    c1->SaveAs("../Plots/ComparisonrecomAOD_AOD.pdf");
