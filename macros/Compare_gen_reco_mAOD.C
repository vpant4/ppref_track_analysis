...
void Compare_gen_reco_mAOD() {
    ...
    TFile *f = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_miniAOD_nopthatw.root","READ");
    ...
    TH1F *htrkptreco_corr = (TH1F*) g2->Get("hpt_inc_corr");
    
    TH1F *htrkptreco_uncorr = (TH1F*) g2->Get("hpt_inc");
    TH1F *htrkptgen       = (TH1F*) g2->Get("hpt_gen_inc");
    ...
    plotComparison(c1, htrkptreco_corr,htrkptreco_uncorr,htrkptgen,hptRatiocorr_uncorr,hptRatioreco_gen, "AOD Reco Corr","AOD Reco uncorr","Gen",0.5,1000.,"Track pT");
    c1->SaveAs("../Plots/MCclosureminiAOD_nopthatw.pdf");
