...
void Compare_gen_mAOD_AOD_eta() {
    ...
    TFile *f = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_AOD_test_onlyHPcut.root","READ");

    TDirectoryFile *g1 = (TDirectoryFile*) f->Get("defaultCPDC");
    TDirectoryFile *g2 = (TDirectoryFile*) g1->Get("QAplots");

    TFile *f1 = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_miniAOD_test_onlyHPcut.root","READ");

    TDirectoryFile *g3 = (TDirectoryFile*) f1->Get("defaultCPDC");
    TDirectoryFile *g4 = (TDirectoryFile*) g3->Get("QAplots");

    
    
    TH1F *htrkptgenaod       = (TH1F*) g2->Get("heta_gen_inc");
    //forest is mini AOD
    TH1F *htrkptgenforest    = (TH1F*) g4->Get("heta_gen_inc");
    ...
    htrkptgenaod->Rebin(4);
    htrkptgenforest->Rebin(4);
    ...
    //    return;
    make1DRatio(hptRatioforaod, htrkptgenaod, "miniAOD/AOD", 2);
    //return;
    ...
    plotComparison(c1, htrkptgenforest,htrkptgenaod,htrkptgenaod,hptRatioforaod,hptRatioforaod, "mini AOD gen","AOD gen","AOD gen",-1,1.,"Track eta");

    c1->SaveAs("../Plots/ComparisongenmAOD_AOD_eta.pdf");
