...
void Compare_gen_reco_forest() {
    ...
    TFile *f = TFile::Open("/Users/vipulpant/cernbox/ppref2024/pprefMCpthat15_forest.root","READ");
   

    TH1F *htrkptreco_corr = (TH1F*) f->Get("htrkpt_corr");
    TH1F *htrkptreco_uncorr = (TH1F*) f->Get("htrkpt");
    TH1F *htrkptgen       = (TH1F*) f->Get("hgentrkpt");
    ...
    TH1F *hptRatiocorr_uncorr = dynamic_cast<TH1F*>( htrkptreco_corr->Clone("htrkptrecocorr") );
    TH1F *hptRatioreco_gen = dynamic_cast<TH1F*>( htrkptreco_corr->Clone("htrkptgen") );
    ...
    plotComparison(c1, htrkptreco_corr,htrkptreco_uncorr,htrkptgen,hptRatiocorr_uncorr,hptRatioreco_gen, "Reco Corr forest","Reco uncorr forest","Gen",0.1,500.,"Track pT");

    c1->SaveAs("../Plots/MCclosuresforest_pthatw.pdf");
